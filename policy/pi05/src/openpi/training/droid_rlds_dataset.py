...
class DroidRldsDataset:
    def __init__(
        ...
        *,  # Force keyword-only arguments
        ...
        num_parallel_reads: int = -1,  # -1 mirrors tf.data.AUTOTUNE without a module-level TensorFlow import.
        num_parallel_calls: int = -1,  # -1 mirrors tf.data.AUTOTUNE without a module-level TensorFlow import.
